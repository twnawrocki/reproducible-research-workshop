---
title: 'BIOL-A601 R Assignment 2'
...
## Display histograms in grid

```{r outputHistogram, fig.height = 5, fig.width = 14, fig.align = "center"}
# Combine plots into a single output and display
